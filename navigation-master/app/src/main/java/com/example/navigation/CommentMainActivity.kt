...
import kotlinx.android.synthetic.main.activity_comment_main.*
...
class CommentMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        saveButton.setOnClickListener {
            ...
            saveComment(author, contents, recommendCount)
    ...
    fun saveComment(author:String, contents:String, recommendCount:Long) {
        val key: String? = databaseRef.child("comments").push().getKey()
        val comment = MovieComment(key!!, author, "", contents, recommendCount)
    ...
    fun loadCommentList(dataSnapshot: DataSnapshot) {
        ...
        if (collectionIterator.hasNext()) {
            ...
            while (itemsIterator.hasNext()) {
                ...
                adapter.items.add(MovieComment(objectId, author, commentTime, contents, recommendCount))
            }
